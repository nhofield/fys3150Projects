...
using namespace std;
double* LocalEnergyT2P(int N_P, int D, double** &pos, double psi_curr, double h_R, double alpha, double beta, double omega,
        ...
        if( fix_specify == "alpha" )
            // Alpha fixed and beta varies
          {
            ...
            MetropolisSampling(N_P, D, MCcycles, StoreValues, fix_value, var_param, omega, h_R,
              TrialWaveFunction2, LocalEnergyT2P, E_Local_Analytic_T2P);
