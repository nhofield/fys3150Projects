...
using namespace std;
double* LocalEnergyT1U(int N_P, int D, double** &pos, double psi_curr, double h_R, double alpha, double beta, double omega,
        ...
        if( fix_specify == "alpha" )
            // Alpha fixed and beta varies
          {
            ...
            MetropolisSampling(N_P, D, MCcycles, StoreValues, fix_value, var_param, omega, h_R,
              TrialWaveFunction1, LocalEnergyT1U, E_Local_Analytic_T1U);
